...
const GenerateRandomArrayControls = ({
	size = 10,
	setSize,
	setCurrentStep,
	boxesRef,
	...
	return (
		<div className="flex gap-2 justify-center items-center flex-wrap max-sm:w-full pb-2">
...
export default GenerateRandomArrayControls;
