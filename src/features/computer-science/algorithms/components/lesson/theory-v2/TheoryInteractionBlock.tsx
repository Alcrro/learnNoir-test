		...
		<div className="lt-interaction-block">
			...
			<div className="lt-interaction-block__toolbar">
				...
				<div className="lt-interaction-block__actions">
					{hasContent && (
						<span
							className={`lt-interaction-block__status lt-interaction-block__status--${interaction.status}`}
						>
			...
			{hasContent || children ? (
				<div
					className={`lt-interaction-block__content${isDraft ? " lt-interaction-block__content--draft" : ""}`}
				>
					{children}
				...
				<div className="lt-interaction-block__empty">
					<Bot
						size={14}
						className="lt-interaction-block__empty-icon"
					/>
