...
export function HomeHero({ isAuthenticated }: Props) {
	...
	return (
		<section className="relative overflow-hidden rounded-[32px] border border-(--border) bg-(--bg-card) px-6 py-16 shadow-sm sm:px-10 lg:px-16 lg:py-24">
			<div
			...
			<div className="relative flex flex-col items-center gap-8 text-center">
				...
				<h1 className="max-w-3xl text-4xl font-semibold tracking-tight text-(--text-primary) sm:text-5xl lg:text-[3.5rem] lg:leading-[1.15]">
					Master algorithms and mathematics through{" "}
					<span className="text-(--blue-text)">structured</span> interactive
					lessons
				</h1>

				<p className="max-w-xl text-base leading-7 text-(--text-secondary) sm:text-lg sm:leading-8">
					Build real understanding with step-by-step visualizations, instant
					feedback and a curriculum designed to last.
				</p>
